...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Notification>|Notification whereReceiverId($value)
     ...
     * @property int $id
     * @property-read \App\Models\User $assigned_to
